...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/RlWNFf1Jzm)
...
```sh
npx nx serve shark-hunt
```

To create a production bundle:

```sh
npx nx build shark-hunt
```

To see all available targets to run for a project, run:

```sh
npx nx show project shark-hunt
```
